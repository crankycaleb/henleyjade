...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.icons.style1', { style: 'tilt-left', speed: 1000, intensity: 2, threshold: 3, delay: 0, stagger: 0, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-right', speed: 1000, intensity: 2, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 1000, intensity: 2, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.container.style2', { style: 'fade-in-background', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.image.style1', { style: 'tilt-left', speed: 1000, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-right', speed: 1000, intensity: 2, threshold: 3, delay: 125, state: true, replay: false });
